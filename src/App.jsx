...
function App() {
  ...
  const [selectedVisualizer, setSelectedVisualizer] = useState("third");
  ...
  return (
    ...
    {playerVisible && 
      ...
      {selectedVisualizer === "third" && 
        <AudioVisualizerParticles2 dataFrequencyLeft={dataFrequencyLeft} dataFrequencyRight={dataFrequencyRight} showGrid={grid}/>
      }
